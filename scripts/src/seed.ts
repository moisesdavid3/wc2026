...
// ── Teams (official WC 2026 draw, Dec 5 2025) ────────────────────────────────
...
// ── Knockout Stage (TBD teams, official dates/venues) ────────────────────────
// Slot labels describe which group-stage slots qualify (e.g. "1A" = 1st place Group A)

type KnockoutMatch = {
  num: number;
  round: string;
  home: string;  // slot label
  away: string;  // slot label
  date: string;
  time: string;
  stadium: string;
  city: string;
...
const knockoutMatches: KnockoutMatch[] = [
  ...
  { num: 73,  round: "Round of 32", home: "1A",  away: "3DEF", date: "2026-07-02", time: "3 p.m.",  stadium: "Estadio Azteca",          city: "Mexico City"      },
  { num: 74,  round: "Round of 32", home: "1C",  away: "3GHI", date: "2026-07-02", time: "6 p.m.",  stadium: "MetLife Stadium",         city: "East Rutherford"  },
  { num: 75,  round: "Round of 32", home: "1B",  away: "3JKL", date: "2026-07-02", time: "9 p.m.",  stadium: "BC Place",                city: "Vancouver"        },
  { num: 76,  round: "Round of 32", home: "1D",  away: "2B",   date: "2026-07-03", time: "12 a.m.", stadium: "SoFi Stadium",            city: "Inglewood"        },
  { num: 77,  round: "Round of 32", home: "1E",  away: "2A",   date: "2026-07-03", time: "3 p.m.",  stadium: "NRG Stadium",             city: "Houston"          },
  { num: 78,  round: "Round of 32", home: "1F",  away: "2C",   date: "2026-07-03", time: "6 p.m.",  stadium: "AT&T Stadium",            city: "Arlington"        },
  { num: 79,  round: "Round of 32", home: "1G",  away: "2E",   date: "2026-07-03", time: "9 p.m.",  stadium: "Lumen Field",             city: "Seattle"          },
  { num: 80,  round: "Round of 32", home: "1H",  away: "2D",   date: "2026-07-04", time: "12 a.m.", stadium: "Hard Rock Stadium",       city: "Miami Gardens"    },
  { num: 81,  round: "Round of 32", home: "1I",  away: "2G",   date: "2026-07-04", time: "3 p.m.",  stadium: "Gillette Stadium",        city: "Foxborough"       },
  { num: 82,  round: "Round of 32", home: "1J",  away: "2F",   date: "2026-07-04", time: "6 p.m.",  stadium: "Arrowhead Stadium",       city: "Kansas City"      },
  { num: 83,  round: "Round of 32", home: "1K",  away: "2H",   date: "2026-07-04", time: "9 p.m.",  stadium: "Mercedes-Benz Stadium",   city: "Atlanta"          },
  { num: 84,  round: "Round of 32", home: "1L",  away: "2I",   date: "2026-07-05", time: "12 a.m.", stadium: "Lincoln Financial Field", city: "Philadelphia"     },
  { num: 85,  round: "Round of 32", home: "2J",  away: "2K",   date: "2026-07-05", time: "3 p.m.",  stadium: "Levi's Stadium",          city: "Santa Clara"      },
  { num: 86,  round: "Round of 32", home: "2L",  away: "3ABC", date: "2026-07-05", time: "6 p.m.",  stadium: "BMO Field",               city: "Toronto"          },
  { num: 87,  round: "Round of 32", home: "3DEF",away: "3GHI", date: "2026-07-05", time: "9 p.m.",  stadium: "Rose Bowl",               city: "Pasadena"         },
  { num: 88,  round: "Round of 32", home: "3JKL",away: "3MNO", date: "2026-07-06", time: "12 a.m.", stadium: "Estadio Tecnológico",     city: "Guadalupe"        },
  // ── Round of 16 (July 8–10) ───────────────────────────────────────────────
  { num: 89,  round: "Round of 16", home: "W73", away: "W74",  date: "2026-07-08", time: "3 p.m.",  stadium: "MetLife Stadium",         city: "East Rutherford"  },
  { num: 90,  round: "Round of 16", home: "W75", away: "W76",  date: "2026-07-08", time: "9 p.m.",  stadium: "SoFi Stadium",            city: "Inglewood"        },
  { num: 91,  round: "Round of 16", home: "W77", away: "W78",  date: "2026-07-09", time: "3 p.m.",  stadium: "AT&T Stadium",            city: "Arlington"        },
  { num: 92,  round: "Round of 16", home: "W79", away: "W80",  date: "2026-07-09", time: "9 p.m.",  stadium: "Hard Rock Stadium",       city: "Miami Gardens"    },
  { num: 93,  round: "Round of 16", home: "W81", away: "W82",  date: "2026-07-10", time: "3 p.m.",  stadium: "Arrowhead Stadium",       city: "Kansas City"      },
  { num: 94,  round: "Round of 16", home: "W83", away: "W84",  date: "2026-07-10", time: "6 p.m.",  stadium: "NRG Stadium",             city: "Houston"          },
  { num: 95,  round: "Round of 16", home: "W85", away: "W86",  date: "2026-07-10", time: "9 p.m.",  stadium: "Rose Bowl",               city: "Pasadena"         },
  { num: 96,  round: "Round of 16", home: "W87", away: "W88",  date: "2026-07-11", time: "12 a.m.", stadium: "Lumen Field",             city: "Seattle"          },
  // ── Quarterfinals (July 14–15) ────────────────────────────────────────────
  { num: 97,  round: "Quarterfinals", home: "W89", away: "W90", date: "2026-07-14", time: "3 p.m.",  stadium: "MetLife Stadium",         city: "East Rutherford"  },
  { num: 98,  round: "Quarterfinals", home: "W91", away: "W92", date: "2026-07-14", time: "9 p.m.",  stadium: "SoFi Stadium",            city: "Inglewood"        },
  { num: 99,  round: "Quarterfinals", home: "W93", away: "W94", date: "2026-07-15", time: "3 p.m.",  stadium: "AT&T Stadium",            city: "Arlington"        },
  { num: 100, round: "Quarterfinals", home: "W95", away: "W96", date: "2026-07-15", time: "9 p.m.",  stadium: "Hard Rock Stadium",       city: "Miami Gardens"    },
  // ── Semifinals (July 17–18) ───────────────────────────────────────────────
  { num: 101, round: "Semifinals",    home: "W97", away: "W98", date: "2026-07-17", time: "9 p.m.",  stadium: "MetLife Stadium",         city: "East Rutherford"  },
  { num: 102, round: "Semifinals",    home: "W99", away: "W100",date: "2026-07-18", time: "9 p.m.",  stadium: "Rose Bowl",               city: "Pasadena"         },
  // ── Third Place (July 18) ─────────────────────────────────────────────────
  { num: 103, round: "Third Place",   home: "L101",away: "L102",date: "2026-07-18", time: "6 p.m.",  stadium: "AT&T Stadium",            city: "Arlington"        },
  // ── Final (July 19) ───────────────────────────────────────────────────────
  { num: 104, round: "Final",         home: "W101",away: "W102",date: "2026-07-19", time: "6 p.m.",  stadium: "MetLife Stadium",         city: "East Rutherford"  },
];

async function seed() {
  console.log("Clearing existing data...");
  await db.execute(sql`TRUNCATE TABLE predictions, matches, teams RESTART IDENTITY CASCADE`);

  console.log("Inserting 48 teams...");
  const insertedTeams = await db.insert(teamsTable).values(teams).returning();
  const byCode = new Map(insertedTeams.map(t => [t.code, t]));
  ...
  for (const m of groupMatches) {
    ...
    if (!home || !away) {
      console.warn(`  ⚠ Skipping match ${m.num}: ${m.home} or ${m.away} not found`);
      continue;
    }
    await db.insert(matchesTable).values({
      homeTeamId: home.id,
      awayTeamId: away.id,
      matchDate: new Date(etToUtc(m.date, m.time)),
      stadium: m.stadium,
      city: m.city,
      round: "Group Stage",
      group: m.group,
  ...
  console.log(`  ✓ ${inserted} group stage matches`);

  console.log("Inserting 32 knockout stage matches...");
  ...
  console.log(`  ✓ ${knockoutInserted} knockout matches`);
